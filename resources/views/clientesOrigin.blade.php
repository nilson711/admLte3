<!DOCTYPE html>
<!-- saved from url=(0052)https://adminlte.io/themes/v3/pages/tables/data.html -->
...
<div class="wrapper">
  ...
  <nav class="main-header navbar navbar-expand navbar-white navbar-light">
    ...
    <ul class="navbar-nav">
      <li class="nav-item">
        <a class="nav-link" data-widget="pushmenu" href="https://adminlte.io/themes/v3/pages/tables/data.html#" role="button"><i class="fas fa-bars"></i></a>
      </li>
      <li class="nav-item d-none d-sm-inline-block">
        <a href="https://adminlte.io/themes/v3/index3.html" class="nav-link">Home</a>
      </li>
      <li class="nav-item d-none d-sm-inline-block">
        <a href="https://adminlte.io/themes/v3/pages/tables/data.html#" class="nav-link">Contact</a>
      </li>
    </ul>
    ...
    <ul class="navbar-nav ml-auto">
      <!-- Navbar Search -->
      <li class="nav-item">
        <a class="nav-link" data-widget="navbar-search" href="https://adminlte.io/themes/v3/pages/tables/data.html#" role="button">
      ...
      <li class="nav-item dropdown">
        <a class="nav-link" data-toggle="dropdown" href="https://adminlte.io/themes/v3/pages/tables/data.html#">
          <i class="far fa-comments"></i>
          <span class="badge badge-danger navbar-badge">3</span>
        </a>
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
          <a href="https://adminlte.io/themes/v3/pages/tables/data.html#" class="dropdown-item">
            <!-- Message Start -->
            <div class="media">
              <img src="css/user1-128x128.jpg" alt="User Avatar" class="img-size-50 mr-3 img-circle">
          ...
          <a href="https://adminlte.io/themes/v3/pages/tables/data.html#" class="dropdown-item">
            <!-- Message Start -->
            <div class="media">
              <img src="css/user8-128x128.jpg" alt="User Avatar" class="img-size-50 img-circle mr-3">
              <div class="media-body">
                <h3 class="dropdown-item-title">
                  John Pierce
          ...
          <a href="https://adminlte.io/themes/v3/pages/tables/data.html#" class="dropdown-item">
            <!-- Message Start -->
            <div class="media">
              <img src="css/user3-128x128.jpg" alt="User Avatar" class="img-size-50 img-circle mr-3">
              <div class="media-body">
                <h3 class="dropdown-item-title">
                  Nora Silvester
          ...
          <div class="dropdown-divider"></div>
          <a href="https://adminlte.io/themes/v3/pages/tables/data.html#" class="dropdown-item dropdown-footer">See All Messages</a>
        </div>
      </li>
      ...
      <li class="nav-item dropdown">
        ...
        <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
          ...
          <div class="dropdown-divider"></div>
          <a href="https://adminlte.io/themes/v3/pages/tables/data.html#" class="dropdown-item dropdown-footer">See All Notifications</a>
        </div>
      </li>
      <li class="nav-item">
        <a class="nav-link" data-widget="fullscreen" href="https://adminlte.io/themes/v3/pages/tables/data.html#" role="button">
          <i class="fas fa-expand-arrows-alt"></i>
        </a>
      </li>
      <li class="nav-item">
        <a class="nav-link" data-widget="control-sidebar" data-slide="true" href="https://adminlte.io/themes/v3/pages/tables/data.html#" role="button">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="https://adminlte.io/themes/v3/index3.html" class="brand-link">
      <img src="css/AdminLTELogo.png" alt="AdminLTE Logo" class="brand-image img-circle elevation-3" style="opacity: .8">
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="css/user2-160x160.jpg" class="img-circle elevation-2" alt="User Image">
        </div>
        <div class="info">
          <a href="https://adminlte.io/themes/v3/pages/tables/data.html#" class="d-block">Alexander Pierce</a>
        </div>
      </div>
      ...
      <div class="form-inline">
        ...
        </div><div class="sidebar-search-results"><div class="list-group"><a href="https://adminlte.io/themes/v3/pages/tables/data.html#" class="list-group-item"><div class="search-title"><strong class="text-light"></strong>N<strong class="text-light"></strong>o<strong class="text-light"></strong> <strong class="text-light"></strong>e<strong class="text-light"></strong>l<strong class="text-light"></strong>e<strong class="text-light"></strong>m<strong class="text-light"></strong>e<strong class="text-light"></strong>n<strong class="text-light"></strong>t<strong class="text-light"></strong> <strong class="text-light"></strong>f<strong class="text-light"></strong>o<strong class="text-light"></strong>u<strong class="text-light"></strong>n<strong class="text-light"></strong>d<strong class="text-light"></strong>!<strong class="text-light"></strong></div><div class="search-path"></div></a></div></div>
      </div>
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            <a href="https://adminlte.io/themes/v3/pages/tables/data.html#" class="nav-link active">
        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="https://adminlte.io/themes/v3/pages/tables/data.html#">Home</a></li>
          ...
          <div class="col-12">
            <div class="card">
              ...
              <div class="card-body">
                ...
                </table></div></div><div class="row"><div class="col-sm-12 col-md-5"><div class="dataTables_info" id="example2_info" role="status" aria-live="polite">Showing 1 to 10 of 57 entries</div></div><div class="col-sm-12 col-md-7"><div class="dataTables_paginate paging_simple_numbers" id="example2_paginate"><ul class="pagination"><li class="paginate_button page-item previous disabled" id="example2_previous"><a href="https://adminlte.io/themes/v3/pages/tables/data.html#" aria-controls="example2" data-dt-idx="0" tabindex="0" class="page-link">Previous</a></li><li class="paginate_button page-item active"><a href="https://adminlte.io/themes/v3/pages/tables/data.html#" aria-controls="example2" data-dt-idx="1" tabindex="0" class="page-link">1</a></li><li class="paginate_button page-item "><a href="https://adminlte.io/themes/v3/pages/tables/data.html#" aria-controls="example2" data-dt-idx="2" tabindex="0" class="page-link">2</a></li><li class="paginate_button page-item "><a href="https://adminlte.io/themes/v3/pages/tables/data.html#" aria-controls="example2" data-dt-idx="3" tabindex="0" class="page-link">3</a></li><li class="paginate_button page-item "><a href="https://adminlte.io/themes/v3/pages/tables/data.html#" aria-controls="example2" data-dt-idx="4" tabindex="0" class="page-link">4</a></li><li class="paginate_button page-item "><a href="https://adminlte.io/themes/v3/pages/tables/data.html#" aria-controls="example2" data-dt-idx="5" tabindex="0" class="page-link">5</a></li><li class="paginate_button page-item "><a href="https://adminlte.io/themes/v3/pages/tables/data.html#" aria-controls="example2" data-dt-idx="6" tabindex="0" class="page-link">6</a></li><li class="paginate_button page-item next" id="example2_next"><a href="https://adminlte.io/themes/v3/pages/tables/data.html#" aria-controls="example2" data-dt-idx="7" tabindex="0" class="page-link">Next</a></li></ul></div></div></div></div>
              </div>
              <!-- /.card-body -->
            </div>
            <!-- /.card -->
            ...
            <div class="card">
              ...
              <div class="card-body">
                ...
                </table></div></div><div class="row"><div class="col-sm-12 col-md-5"><div class="dataTables_info" id="example1_info" role="status" aria-live="polite">Showing 1 to 10 of 57 entries</div></div><div class="col-sm-12 col-md-7"><div class="dataTables_paginate paging_simple_numbers" id="example1_paginate"><ul class="pagination"><li class="paginate_button page-item previous disabled" id="example1_previous"><a href="https://adminlte.io/themes/v3/pages/tables/data.html#" aria-controls="example1" data-dt-idx="0" tabindex="0" class="page-link">Previous</a></li><li class="paginate_button page-item active"><a href="https://adminlte.io/themes/v3/pages/tables/data.html#" aria-controls="example1" data-dt-idx="1" tabindex="0" class="page-link">1</a></li><li class="paginate_button page-item "><a href="https://adminlte.io/themes/v3/pages/tables/data.html#" aria-controls="example1" data-dt-idx="2" tabindex="0" class="page-link">2</a></li><li class="paginate_button page-item "><a href="https://adminlte.io/themes/v3/pages/tables/data.html#" aria-controls="example1" data-dt-idx="3" tabindex="0" class="page-link">3</a></li><li class="paginate_button page-item "><a href="https://adminlte.io/themes/v3/pages/tables/data.html#" aria-controls="example1" data-dt-idx="4" tabindex="0" class="page-link">4</a></li><li class="paginate_button page-item "><a href="https://adminlte.io/themes/v3/pages/tables/data.html#" aria-controls="example1" data-dt-idx="5" tabindex="0" class="page-link">5</a></li><li class="paginate_button page-item "><a href="https://adminlte.io/themes/v3/pages/tables/data.html#" aria-controls="example1" data-dt-idx="6" tabindex="0" class="page-link">6</a></li><li class="paginate_button page-item next" id="example1_next"><a href="https://adminlte.io/themes/v3/pages/tables/data.html#" aria-controls="example1" data-dt-idx="7" tabindex="0" class="page-link">Next</a></li></ul></div></div></div></div>
              </div>
              <!-- /.card-body -->
            </div>
            <!-- /.card -->
...
<script src="js/dataTables.bootstrap4.min.js.download"></script>
<script src="js/dataTables.responsive.min.js.download"></script>
<script src="js/responsive.bootstrap4.min.js.download"></script>
<script src="js/dataTables.buttons.min.js.download"></script>
<script src="js/buttons.bootstrap4.min.js.download"></script>
<script src="js/jszip.min.js.download"></script>
<script src="js/pdfmake.min.js.download"></script>
<script src="js/vfs_fonts.js.download"></script>
<script src="js/buttons.html5.min.js.download"></script>
<script src="js/buttons.print.min.js.download"></script>
<script src="js/buttons.colVis.min.js.download"></script>
<!-- AdminLTE App -->
<script src="js/adminlte.min.js.download"></script>
